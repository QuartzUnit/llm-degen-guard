...
class TestRealWorldDegeneration:
    ...
    def test_vllm_token_loop(self):
        """vLLM Qwen model repeating tokens — real pattern from DGX."""
        guard = DegenGuard()
...
- ZBook Ultra: Agent host, databases, embedding models
- DGX Spark: Primary LLM inference (vLLM)
- Desktop 5090: Secondary LLM (fallback), image generation
"""
